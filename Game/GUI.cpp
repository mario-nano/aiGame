...
void GUI::Keyboard_NormalKeys(unsigned char key, int x, int y){
    ...
    switch (key) {
		...
		/*case 'x': mLogic->mPromotionFlags = 0;
			if (mLogic->mPromotionFlags == 0)glutSetWindowTitle("Promothion is Queen"); break;
		case 'z': mLogic->mPromotionFlags = 1;
			if (mLogic->mPromotionFlags == 1)glutSetWindowTitle("Promothion is Bishop"); break;
		case 'c': mLogic->mPromotionFlags = 2;
			if (mLogic->mPromotionFlags == 2)glutSetWindowTitle("Promothion is Rock"); break;
		case 'v': mLogic->mPromotionFlags = 3;
			if (mLogic->mPromotionFlags == 3)glutSetWindowTitle("Promothion is Knight"); break;*/
    }
}
//---------------------------------------------------------------------
//---------------------------------------------------------------------
